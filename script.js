...
function toggleContent(clickedCard) {
    ...
    // Nếu card đang click không active, mở nó và thu nhỏ các card khác
...
const toggle = document.querySelector('.navbar-toggle');
    ...
    menu.classList.toggle('active');   // Bật/tắt class active cho menu
});
